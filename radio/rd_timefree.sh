...
==============================
元
http://anago.2ch.sc/test/read.cgi/software/1464066155/
...
--no-check-certificate \
-O timeshift.m3u8 \
"https://radiko.jp/v2/api/ts/playlist.m3u8?l=15&station_id=$channel&ft=<start_time>&to=<end_time>"
PLAYLIST_URL=`grep radiko timeshift.m3u8`
ffmpeg -i $PLAYLIST_URL $output.aac



733 ：723 (ﾜｯﾁｮｲ 353f-dxUs)：2016/12/13(火) 21:49:04.66 ID:wuL6M0ym0.net
    >>731
    ありが㌧
    お陰様で屋上屋じゃ無くても安定した
	...
	app=TBS/_definst_
	swfVfy=http://radiko.jp/apps/js/flash/myplayer-release.swf
	timeout=30"
...
http://mycc.s33.xrea.com/data/rpi/rec_radiko.html
